...
// and has been modified by Elastic NV. Changes: updated default HTTP basic auth username from elastic-console to ramen
  ...
  handler: async (args) => {
    ...
    if (args.attach) {
      const headers = (() => {
        ...
        const username = process.env.OPENCODE_SERVER_USERNAME ?? "ramen"
