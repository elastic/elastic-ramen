...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at elastic-console.ai",
  ...
  "Place TUI settings in {highlight}~/.config/elastic-console/tui.json{/highlight} for global config",
  "Add {highlight}$schema{/highlight} to your config for autocomplete in your editor",
  "Configure {highlight}model{/highlight} in config to set your default model",
  "Override any keybind in {highlight}tui.json{/highlight} via the {highlight}keybinds{/highlight} section",
  "Set any keybind to {highlight}none{/highlight} to disable it completely",
  "Configure local or remote MCP servers in the {highlight}mcp{/highlight} config section",
  "Elastic Console auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Elastic Console auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Elastic Console uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent Elastic Console from reading sensitive files",
  "Use {highlight}elastic-console run{/highlight} for non-interactive scripting",
  "Use {highlight}elastic-console --continue{/highlight} to resume the last session",
  "Use {highlight}elastic-console run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}elastic-console serve{/highlight} for headless API access to Elastic Console",
  "Use {highlight}elastic-console run --attach{/highlight} to connect to a running server",
  "Run {highlight}elastic-console upgrade{/highlight} to update to the latest version",
  "Run {highlight}elastic-console auth list{/highlight} to see all configured providers",
  "Run {highlight}elastic-console agent create{/highlight} for guided agent creation",
  "Use {highlight}/elastic-console{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}elastic-console github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/elastic-console fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}elastic-console debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/elastic/elastic-console{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with Elastic Console Zen for curated, tested models",
