...
// and has been modified by Elastic NV. Changes: rebranded all tip text references from Elastic Console/elastic-console to RAMEN/ramen
...
const TIPS = [
  ...
  "Press {highlight}Tab{/highlight} to cycle between Investigate and Plan agents",
  "Use {highlight}/undo{/highlight} to revert the last message and file changes",
  "Use {highlight}/redo{/highlight} to restore previously undone messages and file changes",
  "Run {highlight}/share{/highlight} to create a public link to your conversation at elastic.co",
  ...
  "Create {highlight}elastic_ramen.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "Place TUI settings in {highlight}~/.config/elastic-ramen/tui.json{/highlight} for global config",
  "Add {highlight}$schema{/highlight} to your config for autocomplete in your editor",
  "Configure {highlight}model{/highlight} in config to set your default model",
  "Override any keybind in {highlight}tui.json{/highlight} via the {highlight}keybinds{/highlight} section",
  "Set any keybind to {highlight}none{/highlight} to disable it completely",
  "Configure local or remote MCP servers in the {highlight}mcp{/highlight} config section",
  "RAMEN auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "RAMEN auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "RAMEN uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent RAMEN from reading sensitive files",
  "Use {highlight}ramen run{/highlight} for non-interactive scripting",
  "Use {highlight}ramen --continue{/highlight} to resume the last session",
  "Use {highlight}ramen run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}ramen serve{/highlight} for headless API access to RAMEN",
  "Use {highlight}ramen run --attach{/highlight} to connect to a running server",
  "Run {highlight}ramen upgrade{/highlight} to update to the latest version",
  "Run {highlight}ramen auth list{/highlight} to see all configured providers",
  "Run {highlight}ramen agent create{/highlight} for guided agent creation",
  "Use {highlight}/ramen{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}ramen github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/ramen fix this{/highlight} on issues to auto-create PRs",
  "Comment {highlight}/ec{/highlight} on PR code lines for targeted code reviews",
  ...
  "Run {highlight}ramen debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/elastic/ramen{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with RAMEN Zen for curated, tested models",
