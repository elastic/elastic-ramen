...
const TIPS = [
  ...
  "Place TUI settings in {highlight}~/.config/elastic-sre-agent/tui.json{/highlight} for global config",
  "Add {highlight}$schema{/highlight} to your config for autocomplete in your editor",
  "Configure {highlight}model{/highlight} in config to set your default model",
  "Override any keybind in {highlight}tui.json{/highlight} via the {highlight}keybinds{/highlight} section",
  "Set any keybind to {highlight}none{/highlight} to disable it completely",
  "Configure local or remote MCP servers in the {highlight}mcp{/highlight} config section",
  "Elastic SRE Agent auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Elastic SRE Agent auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Elastic SRE Agent uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent Elastic SRE Agent from reading sensitive files",
  "Use {highlight}elastic-sre-agent run{/highlight} for non-interactive scripting",
  "Use {highlight}elastic-sre-agent --continue{/highlight} to resume the last session",
  "Use {highlight}elastic-sre-agent run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}elastic-sre-agent serve{/highlight} for headless API access to Elastic SRE Agent",
  "Use {highlight}elastic-sre-agent run --attach{/highlight} to connect to a running server",
  "Run {highlight}elastic-sre-agent upgrade{/highlight} to update to the latest version",
  "Run {highlight}elastic-sre-agent auth list{/highlight} to see all configured providers",
  "Run {highlight}elastic-sre-agent agent create{/highlight} for guided agent creation",
  "Use {highlight}/elastic-sre-agent{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}elastic-sre-agent github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/elastic-sre-agent fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}elastic-sre-agent debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/elastic/elastic-sre-agent{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with Elastic SRE Agent Zen for curated, tested models",
