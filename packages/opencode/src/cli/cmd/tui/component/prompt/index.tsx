...
// and has been modified by Elastic NV. Changes: updated no-model warning message to reference /connect command for Kibana setup, removed automatic provider dialog trigger
