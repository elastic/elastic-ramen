...
// and has been modified by Elastic NV. Changes: rebranded agent name/label to RAMEN, removed opencode provider priority, defaulted fallback model to Kibana LLM Gateway
import {
  RequestError,
